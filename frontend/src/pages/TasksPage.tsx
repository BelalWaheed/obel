...
export default function TasksPage() {
  ...
  const [selectedTaskDetailsId, setSelectedTaskDetailsId] = useState<
    string | null
  >(null);
  ...
  }, [tasks, filterStatus, searchQuery, getFilteredTasks]);
    ...
    <div className="space-y-6 max-w-[100vw] sm:max-w-none ">
      ...
      {isLoading && (
        <div className="text-center py-20">
          ...
          <p className="text-md font-bold text-muted-foreground mt-6 uppercase tracking-widest opacity-50">
            Syncing Workspace...
          </p>
        </div>
      )}
      ...
      <div className="flex flex-col md:flex-row md:items-start md:overflow-x-auto md:pb-8 gap-4 min-h-[calc(100vh-250px)] custom-scrollbar">
